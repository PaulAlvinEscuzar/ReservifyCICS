        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active me-3" href="../student/contactus.php"><h4><i class="bi bi-envelope-fill d-none d-md-block"></i><p class="d-block d-md-none text-center bg-primary p-3 text-light">Contact Us</p></h4></a>
                    <div class="container">

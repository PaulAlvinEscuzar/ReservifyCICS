    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link active me-3 btn btn-outline-primary btn-rounded text-wrap" style="color:white ;" aria-current="page" href="../admin/customerDetails.php">
    ...
    <div class="container-lg">
        <div class="row-mt-5">
            ...
            <body>
                ...
                <h1 class="text-center pt-3">Customer Details</h1>
